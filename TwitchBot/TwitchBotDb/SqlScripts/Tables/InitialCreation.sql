...
/****** Object:  Table [Cmd].[CustomCommand]    Script Date: 2/3/2022 7:34:30 PM ******/
SET ANSI_NULLS ON;
GO
...
ALTER AUTHORIZATION ON [Cmd].[CustomCommand] TO SCHEMA OWNER;
GO

/****** Object:  Table [Cmd].[Whitelist]    Script Date: 2/3/2022 7:34:31 PM ******/
SET ANSI_NULLS ON;
GO
...
ALTER AUTHORIZATION ON [Cmd].[Whitelist] TO SCHEMA OWNER;
GO

/****** Object:  Table [dbo].[Bank]    Script Date: 2/3/2022 7:34:32 PM ******/
SET ANSI_NULLS ON;
GO
...
/****** Object:  Table [dbo].[BankHeistSetting]    Script Date: 2/3/2022 7:34:33 PM ******/
SET ANSI_NULLS ON;
GO
...
(
  ...
  , [EntryMessage] [VARCHAR](150) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
  , [MaxGamble] [INT] NOT NULL
  , [MaxGambleText] [VARCHAR](100) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
  , [EntryInstructions] [VARCHAR](50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
  , [CooldownEntry] [VARCHAR](150) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
  , [CooldownOver] [VARCHAR](150) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
  , [NextLevelMessage2] [VARCHAR](200) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
  , [NextLevelMessage3] [VARCHAR](200) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
  , [NextLevelMessage4] [VARCHAR](200) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
  , [NextLevelMessage5] [VARCHAR](200) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
  , [GameStart] [VARCHAR](200) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
  , [SingleUserSuccess] [VARCHAR](200) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
  , [SingleUserFail] [VARCHAR](200) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
  , [ResultsMessage] [VARCHAR](50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
  , [Success100] [VARCHAR](200) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
  , [Success34] [VARCHAR](200) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
  , [Success1] [VARCHAR](200) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
  , [Success0] [VARCHAR](200) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
  , [LevelName1] [VARCHAR](50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
  , [LevelMaxUsers1] [INT] NOT NULL
  , [LevelName2] [VARCHAR](50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
  , [LevelMaxUsers2] [INT] NOT NULL
  , [LevelName3] [VARCHAR](50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
  , [LevelMaxUsers3] [INT] NOT NULL
  , [LevelName4] [VARCHAR](50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
  , [LevelMaxUsers4] [INT] NOT NULL
  , [LevelName5] [VARCHAR](50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
...
ALTER AUTHORIZATION ON [dbo].[BankHeistSetting] TO SCHEMA OWNER;
GO

/****** Object:  Table [dbo].[BossFightBossStats]    Script Date: 2/3/2022 7:34:37 PM ******/
SET ANSI_NULLS ON;
GO
...
(
  ...
  , [Name2] [VARCHAR](50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
  ...
  , [Name3] [VARCHAR](50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
  ...
  , [Name4] [VARCHAR](50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
  ...
  , [Name5] [VARCHAR](50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
...
ALTER AUTHORIZATION ON [dbo].[BossFightBossStats] TO SCHEMA OWNER;
GO

/****** Object:  Table [dbo].[BossFightClassStats]    Script Date: 2/3/2022 7:34:41 PM ******/
SET ANSI_NULLS ON;
GO
...
ALTER AUTHORIZATION ON [dbo].[BossFightClassStats] TO SCHEMA OWNER;
GO

/****** Object:  Table [dbo].[BossFightSetting]    Script Date: 2/3/2022 7:34:43 PM ******/
SET ANSI_NULLS ON;
GO
...
ALTER AUTHORIZATION ON [dbo].[BossFightSetting] TO SCHEMA OWNER;
GO

/****** Object:  Table [dbo].[Broadcaster]    Script Date: 2/3/2022 7:34:45 PM ******/
SET ANSI_NULLS ON;
GO
...
ALTER AUTHORIZATION ON [dbo].[Broadcaster] TO SCHEMA OWNER;
GO

/****** Object:  Table [dbo].[DiscordSelfRoleAssign]    Script Date: 2/3/2022 7:34:46 PM ******/
SET ANSI_NULLS ON;
GO
...
CREATE TABLE [dbo].[DiscordSelfRoleAssign]
(
    [Id] [INT] IDENTITY(1, 1) NOT NULL
  , [RoleName] [VARCHAR](127) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
  , [ServerName] [VARCHAR](127) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
  , [FollowAgeMinimumHour] [INT] NOT NULL
  , [BroadcasterId] [INT] NOT NULL
  , CONSTRAINT [PK_DiscordSelfRoleAssign]
        PRIMARY KEY CLUSTERED ([Id] ASC)
        WITH (STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY];
GO

ALTER AUTHORIZATION ON [dbo].[DiscordSelfRoleAssign] TO SCHEMA OWNER;
GO

/****** Object:  Table [dbo].[ErrorLog]    Script Date: 2/3/2022 7:34:47 PM ******/
SET ANSI_NULLS ON;
GO
...
(
  ...
  , [ErrorClass] [VARCHAR](100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
  , [ErrorMethod] [VARCHAR](100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
  , [ErrorMsg] [VARCHAR](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
  , [BroadcasterId] [INT] NOT NULL
  , [Command] [VARCHAR](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
  , [UserMsg] [VARCHAR](500) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
...
/****** Object:  Table [dbo].[InGameUsername]    Script Date: 2/3/2022 7:34:48 PM ******/
SET ANSI_NULLS ON;
GO
...
ALTER AUTHORIZATION ON [dbo].[InGameUsername] TO SCHEMA OWNER;
GO

/****** Object:  Table [dbo].[PartyUp]    Script Date: 2/3/2022 7:34:49 PM ******/
SET ANSI_NULLS ON;
GO
...
(
    [Id] [INT] IDENTITY(1, 1) NOT NULL
  , [PartyMemberName] [VARCHAR](100) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
  , [GameId] [INT] NOT NULL
  , [BroadcasterId] [INT] NOT NULL
...
ALTER AUTHORIZATION ON [dbo].[PartyUp] TO SCHEMA OWNER;
GO

/****** Object:  Table [dbo].[PartyUpRequest]    Script Date: 2/3/2022 7:34:49 PM ******/
SET ANSI_NULLS ON;
GO
...
ALTER AUTHORIZATION ON [dbo].[PartyUpRequest] TO SCHEMA OWNER;
GO

/****** Object:  Table [dbo].[Quote]    Script Date: 2/3/2022 7:34:50 PM ******/
SET ANSI_NULLS ON;
GO
...
(
    [Id] [INT] IDENTITY(1, 1) NOT NULL
  , [UserQuote] [VARCHAR](500) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
...
ALTER AUTHORIZATION ON [dbo].[Quote] TO SCHEMA OWNER;
GO

/****** Object:  Table [dbo].[Rank]    Script Date: 2/3/2022 7:34:51 PM ******/
SET ANSI_NULLS ON;
GO
...
ALTER AUTHORIZATION ON [dbo].[Rank] TO SCHEMA OWNER;
GO

/****** Object:  Table [dbo].[RankFollower]    Script Date: 2/3/2022 7:34:52 PM ******/
SET ANSI_NULLS ON;
GO
...
(
  ...
  , CONSTRAINT [PK_RankFollower]
        PRIMARY KEY CLUSTERED ([Id] ASC)
        WITH (STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
  , CONSTRAINT [UK_RankFollower_Username]
        UNIQUE NONCLUSTERED ([Username] ASC, [BroadcasterId] ASC)
        WITH (STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY];
GO

ALTER AUTHORIZATION ON [dbo].[RankFollower] TO SCHEMA OWNER;
GO

/****** Object:  Table [dbo].[Reminder]    Script Date: 2/3/2022 7:34:53 PM ******/
SET ANSI_NULLS ON;
GO
...
ALTER AUTHORIZATION ON [dbo].[Reminder] TO SCHEMA OWNER;
GO

/****** Object:  Table [dbo].[SongRequest]    Script Date: 2/3/2022 7:34:55 PM ******/
SET ANSI_NULLS ON;
GO
...
ALTER AUTHORIZATION ON [dbo].[SongRequest] TO SCHEMA OWNER;
GO

/****** Object:  Table [dbo].[SongRequestIgnore]    Script Date: 2/3/2022 7:34:56 PM ******/
SET ANSI_NULLS ON;
GO
...
(
    [Id] [INT] IDENTITY(1, 1) NOT NULL
  , [Artist] [VARCHAR](100) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
...
ALTER AUTHORIZATION ON [dbo].[SongRequestIgnore] TO SCHEMA OWNER;
GO

/****** Object:  Table [dbo].[SongRequestSetting]    Script Date: 2/3/2022 7:34:57 PM ******/
SET ANSI_NULLS ON;
GO
...
(
    [Id] [INT] IDENTITY(1, 1) NOT NULL
  , [RequestPlaylistId] [VARCHAR](34) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
  , [PersonalPlaylistId] [VARCHAR](34) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
  , [DjMode] [BIT] NOT NULL
  , [BroadcasterId] [INT] NOT NULL
...
ALTER AUTHORIZATION ON [dbo].[SongRequestSetting] TO SCHEMA OWNER;
GO

/****** Object:  Table [dbo].[TwitchGameCategory]    Script Date: 2/3/2022 7:34:58 PM ******/
SET ANSI_NULLS ON;
GO
...
ALTER AUTHORIZATION ON [dbo].[TwitchGameCategory] TO SCHEMA OWNER;
GO

SET ANSI_PADDING ON;
GO

/****** Object:  Index [CIDX]    Script Date: 2/3/2022 7:34:58 PM ******/
CREATE CLUSTERED INDEX [CIDX]
    ON [dbo].[TwitchGameCategory] ([Title] ASC)
...
ALTER TABLE [dbo].[BankHeistSetting]
ADD
    DEFAULT ((120)) FOR [EntryPeriodSec];
GO
...
ADD
    DEFAULT ((10)) FOR [ViewerAttack];
GO

ALTER TABLE [dbo].[BossFightClassStats]
ADD
    DEFAULT ((5)) FOR [ViewerDefense];
GO
...
ALTER TABLE [dbo].[DiscordSelfRoleAssign] WITH CHECK
ADD CONSTRAINT [FK_DiscordSelfRoleAssign_Broadcaster]
    FOREIGN KEY ([BroadcasterId])
    REFERENCES [dbo].[Broadcaster] ([Id]);
GO

ALTER TABLE [dbo].[DiscordSelfRoleAssign] CHECK CONSTRAINT [FK_DiscordSelfRoleAssign_Broadcaster];
GO
